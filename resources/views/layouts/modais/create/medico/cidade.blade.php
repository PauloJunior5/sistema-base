                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" id="uf-estado-input-medico" type="text" value="" required />
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#medico-estadoModal" style="margin-top: 2.7rem;"><i class="material-icons">search</i></button>
                                    </div>
                                </div>
                                <div class="col-sm-4">

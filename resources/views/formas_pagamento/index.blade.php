                                    ...
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <form action="{{ route('formaPagamento.destroy', $forma_pagamento->id) }}" method="post">
                                                ...
                                                <button type="button" class="btn btn-danger btn-link" data-original-title="" title="" onclick="confirm('{{ __("Are you sure you want to delete this Forma de Pagamento?") }}') ? this.parentElement.submit() : ''">
                                                    <i class="material-icons">close</i>
                                                    <div class="ripple-container"></div>
                                                </button>
                                            </form>

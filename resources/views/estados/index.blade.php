...
@extends('layouts.app', ['activePage' => 'estados-management', 'titlePage' => __('Estado Management')])
                    ...
                    <tbody>
                      @foreach($estados as $estado)
                        <tr>
                          ...
                          <td>
                            {{ $pais = App\Pais::where('id', $estado->pais)->get()->first()->nome }}
                          </td>
                          <td>
                            {{ $estado->created_at->format('Y-m-d') }}
                          </td>
